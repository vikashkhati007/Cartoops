...
export default function Hero() {
  return (
    <section className="relative bg-gradient-to-b from-indigo-600 to-indigo-800 text-white overflow-hidden w-full mb-10 h-screen flex justify-center items-center">
